    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="<?php echo $base_url; ?>buku/list.php">Daftar Buku</a></li>
                <li><a href="<?php echo $base_url; ?>buku/tambah.php">Tambah Buku</a></li>
                <li><a href="<?php echo $base_url; ?>anggota/list.php">Daftar Anggota</a></li>
                <li><a href="<?php echo $base_url; ?>anggota/tambah.php">Tambah Anggota</a></li>
            </ul>
        </nav>
    </header>
    <main>